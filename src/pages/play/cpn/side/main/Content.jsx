...
const Content = () => {
    ...
    return <div className={`flex p-[10px] gap-1 flex-wrap bg-white rounded-[8px]`}>
        {data?.episodeList?.map((item, index) => {
            return <div className={`episode border border-solid border-[#e9ecef] py-[2px] px-[8px] rounded-[8px] cursor-pointer
